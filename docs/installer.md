...
把 **`SimPy-Lab-Studio-Setup-1.3.0.exe`** 发给对方即可，也可以分享 [GitHub 下载页](https://github.com/Sylphiette666/SimPy-Lab-Studio/releases/latest)。无需发送源代码、Python 环境、CMD 文件或自己的实验目录。
...
v1.3.0 还验证了先安装旧版 1.2.0、再使用 1.3.0 安装程序覆盖升级的流程，核对安装登记和 EXE 版本号一致。开发者可给 `tools/check_installer.ps1` 传入 `-BaselineInstallerPath` 指定旧版安装包。
